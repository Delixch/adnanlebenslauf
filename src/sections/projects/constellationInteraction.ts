...
export class ConstellationInteraction {
    ...
    public syncKeyboardNavigator(): void {
        ...
        heading.textContent = 'Projekt-Konstellation';
        instructions.id = 'constellation-keyboard-instructions';
        instructions.className = 'constellation-keyboard-nav__instructions';
        instructions.textContent =
            'Mit Auf und Ab zwischen Projekten wechseln, mit Links und Rechts die Konstellation wechseln, dann Enter für Details drücken.';
    ...
    public setKeyboardActiveSkill(skillId?: string): void {
        ...
        if (instructions) {
            instructions.textContent = skillId
                ? 'Mit Auf und Ab zwischen Projekten wechseln, dann Enter für Details drücken.'
                : 'Mit Auf und Ab zwischen Projekten wechseln, mit Links und Rechts die Konstellation wechseln, dann Enter für Details drücken.';
        }
    ...
    private createKeyboardNavigator(): void {
        ...
        this.keyboardNavigator.setAttribute('aria-label', 'Projekt-Konstellation');

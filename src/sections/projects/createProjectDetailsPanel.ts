...
const createProjectDetailsPanel = (
    ...
    previousButton.setAttribute('aria-label', 'Vorheriges Projekt anzeigen');

    nextButton.className = 'project-details__control project-details__control--next';
    nextButton.type = 'button';
    nextButton.setAttribute('aria-label', 'Nächstes Projekt anzeigen');

    closeButton.className = 'project-details__close';
    closeButton.type = 'button';
    closeButton.setAttribute('aria-label', 'Projektdetails schliessen');
    ...
    liveLink.className = 'project-details__live-link';
    liveLink.target = '_blank';
    liveLink.rel = 'noopener noreferrer';
    liveLink.textContent = 'Live ansehen ↗';
    ...
    periodTerm.textContent = 'Zeitraum';
    roleTerm.textContent = 'Rolle';
    domainTerm.textContent = 'Bereich';
    ownerTerm.textContent = 'Auftraggeber';
    meta.append(
        periodTerm,
        periodValue,
        roleTerm,
    ...
    content.append(screenshotFrame, eyebrow, title, summary, liveLink, meta, tagList);
    panel.append(controls, content);
    document.body.append(panel);

    const animatedContent = [eyebrow, title, summary, liveLink, meta, tagList];

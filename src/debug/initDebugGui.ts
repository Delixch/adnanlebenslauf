...
export const initDebugGui = ({
    ...
    const gui = new GUI({ title: 'Szene · Debug' });
    ...
    // Das Panel hängt als Eintrag in der Seitennavigation und ist bis zum Klick unsichtbar.
    // Es öffnet unterhalb der Navigation und wächst nach unten.
    ...
    // Die Navigation blendet sich beim Scrollen aus, darum schliesst das Panel auch von innen.
    const closeButton = document.createElement('button');
    closeButton.type = 'button';
    closeButton.textContent = '×';
    closeButton.setAttribute('aria-label', 'Debug-Panel schliessen');
    ...
    // Halo statt Button-Fläche: hebt den Eintrag ab, ohne den Look der Navigation zu brechen.

    ...
    (async () => {
        try {
            ...
            const shapeTargets: Record<SceneMorphTargetKey, Float32Array> = {
                name: createTextMorphPositions(regularFont, 'ADNAN AYDIN', cloudPositions),
                experience: createTextMorphPositions(regularFont, 'ERFAHRUNG', cloudPositions),
                education: createTextMorphPositions(regularFont, 'AUSBILDUNG', cloudPositions),
                projects: createTextMorphPositions(regularFont, 'PROJEKTE', cloudPositions),

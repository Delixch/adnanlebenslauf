...
import { LanyardSystem } from './systems/LanyardSystem';
...
export class World {
    ...
    private lanyardSystem: LanyardSystem | undefined;
    ...
    public update(delta: number, elapsed: number): void {
        ...
        this.lanyardSystem?.update(safeDelta);
    ...
    public resize = (viewportSize = getRendererViewportSize(this.renderer.domElement)): void => {
        ...
        this.lanyardSystem?.setResponsiveConfig(nextResponsiveConfig);
    ...
    private async init3d(
        ...
        await yieldToMainThread();
        this.lanyardSystem = new LanyardSystem(
            this.scene,
            this.camera,
